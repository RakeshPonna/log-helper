...
public class AndroidHandler extends Handler {
    ...
    AndroidHandler(Context context, String tag, boolean logcatEnabled, Level level) {
        this(context, tag, logcatEnabled, level, MAX_FILE_SIZE, MEMORY_SIZE, Level.WARNING);
    }

    AndroidHandler(Context context, String tag, boolean logcatEnabled, Level level, int maxFileSize, int memorySize, Level pushLevel) {
        this.tag = tag;
